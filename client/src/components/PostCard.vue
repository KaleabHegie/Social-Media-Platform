      ...
      <div class="relative">
        ...
        <div class="absolute top-0 left-0 right-0 z-10 p-4 bg-gradient-to-b from-black/60 to-transparent">
          <div class="flex items-center">
            <router-link :to="`/user/${post.username}`" class="flex items-center group">
              ...
              <div class="ml-3">
                <h2 class="text-white font-semibold group-hover:underline">{{ post.username }}</h2>
        ...
        <div class="relative">
          ...
          <!-- Carousel Navigation -->
          <div v-if="post.media.length > 1" class="absolute bottom-4 left-0 right-0 flex justify-center gap-2">
            <button 
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center space-x-4">
            ...
            <button class="flex items-center space-x-2 group" aria-label="View comments">
              ...
              />
              <span class="text-sm text-gray-600 dark:text-gray-400">{{ post.comments }}</span>
            </button>
          </div>
        </div>
...
.fade-mask {
    ...
    mask-image: linear-gradient(to bottom, rgb(0, 0, 0) 20%, transparent 100%);
