  ...
  <router-link :to="`/viewpost/${props.post._id}`" class="block">
    ...
    >
      ...
      <div class="relative fade-mask">
        <!-- User Info Overlay -->
        <div
          class="absolute top-0 left-0 right-0 z-10 p-4 bg-gradient-to-b from-black/60 to-transparent"
        >
          <div class="flex items-center">
            ...
            >
              <div
                class="relative w-10 h-10 rounded-full overflow-hidden border-2 border-white"
              >
                <img
              ...
              <div class="ml-3">
                <h2
                  class="text-white font-semibold group-hover:underline"
                >
                  {{ props.post.username }}
                </h2>
                <time
        ...
        <div class="relative">
          ...
          >
            <div
              v-for="(media, index) in props.post.medias"
              :key="index"
      ...
      <div class="p-4">
        ...
        <div class="flex items-center justify-between mb-4">
          <div class="flex items-center space-x-4">
            ...
            >
              <i
                class="ri-chat-1-line text-xl text-gray-600 dark:text-gray-400 group-hover:scale-110 transition-transform"
              ></i>
              <span
                class="text-sm text-gray-600 dark:text-gray-400"
              >
